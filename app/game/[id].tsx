...
import { StyleSheet, ScrollView, Pressable, Alert, useWindowDimensions } from 'react-native';
  ...
  return (
    <ThemedView style={styles.container}>
      <ScrollView style={styles.scroll} contentContainerStyle={[styles.content, { maxWidth: isDesktop ? 960 : 640 }]} showsVerticalScrollIndicator={false}>
        ...
        {/* Responsive Desktop 2-Column Section */}
        <ThemedView style={isDesktop ? styles.desktopMainRow : styles.mobileMainCol}>
          {/* Column 1: Account Input & Roblox Method Selector */}
          <ThemedView style={[isDesktop ? styles.columnLeftDesktop : styles.columnFull, styles.section]}>
            {isRoblox && (
              <>
          ...
          {/* Column 2: Nominal Package Selection Grid & Pay Button */}
          <ThemedView style={[isDesktop ? styles.columnRightDesktop : styles.columnFull, styles.section]}>
            <ThemedView style={styles.stepTitleRow}>
              <ThemedView style={styles.stepBadge}>
...
const styles = StyleSheet.create({
  ...
  gameTitle: { fontSize: 26, fontWeight: '800', color: '#333' },
  gameSub: { fontSize: 13, color: '#888' },

  mobileMainCol: { gap: 16 },
  desktopMainRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 16 },
  columnFull: { width: '100%' },
  columnLeftDesktop: { flex: 1 },
  columnRightDesktop: { flex: 1 },
